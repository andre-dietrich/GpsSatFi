...
grab_gps_ops()
{
	echo "wget -N -c -O ./data/gps-ops.txt http://www.celestrak.com/NORAD/elements/gps-ops.txt"
	wget -N -c -O ./data/gps-ops.txt http://www.celestrak.com/NORAD/elements/gps-ops.txt
	return
}
...
satellite()
{
    ...
    KEY=AngZwqZidmGDKiF5MYN7Y72vcNELdGES1Rcb7B-IyPnJaxStCnegl76bDOn_Hl41
    FMT=jpeg
    WIDTH=$5
